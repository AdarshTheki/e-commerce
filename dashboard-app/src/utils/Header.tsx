...
import { Phone, Mail, ShoppingCart, CakeSlice, Menu, MapPin, Store, Search } from 'lucide-react';

const Header = () => {
  const user = useSelector((state: RootState) => state.auth.user);

  return (
    <header id='header' className='sticky top-0 left-0 w-full bg-white shadow-sm z-20'>
