                    ...
                    <div className='grid md:grid-cols-3 gap-8'>
                        <div className='bg-white p-6 rounded-lg shadow-sm'>
                            ...
                            <p className='text-gray-600'>
                                &doublequote;Great products and excellent service. Will definitely
                                shop here again!&doublequote;
                            </p>
                        </div>
                        ...
                        <div className='bg-white p-6 rounded-lg shadow-sm'>
                            ...
                            <p className='text-gray-600'>
                                &doublequote;Quality products at great prices. Very satisfied with
                                my purchase!&doublequote;
                            </p>
                        </div>
                    </div>
                </div>
