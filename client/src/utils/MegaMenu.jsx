      ...
      <div className='absolute top-full border left-0 w-full bg-white shadow-xl z-50 hidden rounded-lg group-hover:block max-h-[70vh] overflow-y-auto'>
        <div className='max-w-7xl mx-auto px-4 py-6'>
          <div className='grid sm:grid-cols-5 gap-8'>
            ...
            <div className='space-y-4'>
              <h3 className='font-semibold text-lg border-b pb-2'>Electronics</h3>
              <ul className='space-y-2 max-sm:flex items-center flex-wrap'>
                <li>
                  <a href='#' className='hover:text-blue-600 flex items-center'>
            ...
            {/* <!-- Home & Living --> */}
            <div className='space-y-4'>
              <h3 className='font-semibold text-lg border-b pb-2'>Home &amp; Living</h3>
              <ul className='space-y-2 max-sm:flex items-center flex-wrap'>
                <li>
                  <a href='#' className='hover:text-blue-600 flex items-center'>
            ...
            {/* <!-- Beauty & Health --> */}
            <div className='space-y-4'>
              <h3 className='font-semibold text-lg border-b pb-2'>Beauty &amp; Health</h3>
              <ul className='space-y-2 max-sm:flex items-center flex-wrap'>
                <li>
                  <a href='#' className='hover:text-blue-600 flex items-center'>
            ...
            {/* <!-- Featured Brands --> */}
            <div className='space-y-4'>
              <h3 className='font-semibold text-lg border-b pb-2'>Featured Brands</h3>
          ...
          <div className='mt-8 p-4 bg-gray-100 rounded-lg'>
            <div className='flex justify-between items-center'>
              <div className='space-y-2'>
                ...
                <p className='text-sm text-gray-600'>Get 20% off on your first purchase</p>
