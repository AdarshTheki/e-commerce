...
const Tabs = ({ tabs, totals, items, formData }) => {
  ...
  if (activeTab === 4) return tabs[activeTab]?.content; // order success
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              {tabs[activeTab]?.label || "Proceed to Checkout"}
            </button>
