  ...
  return (
    <div className="mx-auto container" id="categories">
      <div className="mb-10 space-y-5">
        <p class="text-3xl md:text-4xl font-bold text-center">Categories</p>
      ...
      <div className="sm:grid flex md:grid-cols-4 sm:grid-cols-3 gap-5 grid-cols-2 overflow-x-auto scrollbar-hidden">
        {items &&
          items?.slice(0, 8).map((item) => (
            <div
              key={item._id}
              class="group max-sm:min-w-64 relative overflow-hidden rounded-lg shadow-md transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <img
                src={
                  item.thumbnail ||
                ...
                alt="Electronics"
                class="w-full object-cover aspect-[6/5]  transition-transform duration-500 group-hover:scale-110"
              />
              <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                <div class="p-6 w-full">
                  <p class="text-xl font-bold text-white mb-2 capitalize">
                    {item.title || "Electronics"}
                  </p>
                  <div class="flex justify-between items-center">
                    <span class="text-white text-sm">48 Products</span>
                    <NavLink
      ...
      <div class="flex justify-center mt-4 md:hidden">
        <div class="flex space-x-2">
          <div class="w-8 h-2 bg-indigo-600 rounded-full"></div>
